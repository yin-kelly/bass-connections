...
create_lollipop_chart(
  ...
  title = "Average Daily Screen Time by Social Media Platform Type",
  y_label = "Time\n(minutes)",
  y_break_interval = 20,
  color = "#355463",
...
create_bar_chart(
  ...
  title = "Average Weekly Posts by Social Media Platform Type",
  y_label = "Posts per\nWeek",
  y_break_interval = 20,
  color = "#355463",
...
create_dot_plot(
  ...
  title = "Average Followers by Social Media Platform Type",
  y_label = "Number of\nFollowers",
...
create_bar_chart(
  ...
  category_col = platform_type,
  value_col = connections,
  title = "Average Number of Followers by Social Media Platform Type",
  y_label = "Number of\nFollowers",
  y_break_interval = 100,
  color = "#355463",
...
create_bar_chart(
  ...
  title = "TV Episodes Watched per Binge Session by Content Type",
  y_label = "Number of\nEpisodes",
  y_break_interval = 2,
  color = "#7D6B7D",
...
create_dot_plot(
  ...
  title = "Total TV Weekly Viewing Hours by Content Type",
  y_label = "Hours per\nWeek",
  y_break_interval = 2,
  color = "#7D6B7D",
...
create_lollipop_chart(
  ...
  title = "Average Days to Complete a TV Series by Content Type",
  y_label = "Number of\nDays",
  y_break_interval = 2,
  color = "#7D6B7D",
