...
create_lollipop_chart(
  data = library_data |> mutate(digital_usage_pct = digital_usage_rate * 100),
  category_col = age_range,
  value_col = digital_usage_pct,
  title = "Digital Library Resource Usage Rate by Age Group",
  y_label = "Digital Usage\nRate (%)",
  y_break_interval = 10,
  color = "dodgerblue4",
  output_file = "trisha-stimuli-pngs/library_digital_lollipop.png"
)
...
create_bar_chart(
  ...
  y_break_interval = 10,
  color = "dodgerblue4",
  output_file = "trisha-stimuli-pngs/library_digital_bar.png"
)
...
create_dot_plot(
  ...
  y_break_interval = 10,
  color = "dodgerblue4",
  output_file = "trisha-stimuli-pngs/library_digital_dot.png"
)
```
