...
library_data <- read_csv("datasets/library_revised.csv")
...
create_lollipop_chart(
  data = library_data,
  category_col = age_range,
  value_col = ebooks_checked_out,
  title = "Number of E-books Checked Out by Age Group",
  y_label = "E-books\nChecked Out",
  y_break_interval = 50,
  color = "dodgerblue4",
  output_file = "stimuli-pngs/library_ebooks_lollipop.png"
)
...
create_bar_chart(
  ...
  y_break_interval = 50,
  color = "dodgerblue4",
  output_file = "stimuli-pngs/library_ebooks_bar.png"
)
...
create_dot_plot(
  ...
  y_break_interval = 50,
  color = "dodgerblue4",
  output_file = "stimuli-pngs/library_ebooks_dot.png"
)
```
...
create_lollipop_chart(
  ...
  y_break_interval = 50,
  color = "goldenrod2",
  output_file = "stimuli-pngs/fair_spending_lollipop.png"
)
...
create_bar_chart(
  ...
  y_break_interval = 50,
  color = "goldenrod2",
  output_file = "stimuli-pngs/fair_spending_bar.png"
)
...
create_dot_plot(
  ...
  y_break_interval = 50,
  color = "goldenrod2",
  output_file = "stimuli-pngs/fair_spending_dot.png"
)
...
create_lollipop_chart(
  ...
  output_file = "stimuli-pngs/credit_balance_lollipop.png"
)
...
create_bar_chart(
  ...
  y_break_interval = 5,
  color = "darkolivegreen3",
  output_file = "stimuli-pngs/credit_balance_bar.png"
)
...
create_dot_plot(
  ...
  y_break_interval = 5,
  color = "darkolivegreen3",
  output_file = "stimuli-pngs/credit_balance_dot.png"
)
...
create_lollipop_chart(
  ...
  y_break_interval = 5,
  color = "darkolivegreen3",
  output_file = "stimuli-pngs/credit_customers_lollipop.png"
)
...
create_bar_chart(
  ...
  y_break_interval = 5,
  color = "darkolivegreen3",
  output_file = "stimuli-pngs/credit_customers_bar.png"
)
...
create_dot_plot(
  ...
  y_break_interval = 5,
  color = "darkolivegreen3",
  output_file = "stimuli-pngs/credit_customers_dot.png"
)
```
